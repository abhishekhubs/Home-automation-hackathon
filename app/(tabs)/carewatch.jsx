        ...
        {state.careContacts.map((c, i) => (
          <View key={i} style={styles.contactRow}>
            ...
            <View style={styles.contactBtns}>
              <TouchableOpacity style={styles.callBtn} onPress={() => { setCalling(c.name); setTimeout(() => setCalling(null), 3000); }}>
                <Text style={styles.callBtnText}>{calling === c.name ? 'Calling…' : '📞 Call'}</Text>
              </TouchableOpacity>
